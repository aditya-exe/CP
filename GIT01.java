...
class GIT01 {
    ...
    void main() throws IOException {
        ...
        while (t-- > 0) {
            ...
            for (int i = 0; i < n; i++) {
                if (i % 2 == 0) {
                    for (int j = 0; j < m; j++) {
                        if (j % 2 == 0 && s[i].charAt(j) != 'G')
                            cost1 += 5;
                        else if (j % 2 != 0 && s[i].charAt(j) != 'R')
                            cost1 += 3;
                    }
                } else {
                    for (int j = 0; j < m; j++) {
                        if (j % 2 == 0 && s[i].charAt(j) != 'R')
                            cost1 += 3;
                        else if (j % 2 != 0 && s[i].charAt(j) != 'G')
                            cost1 += 5;
                    }
                }
    ...
    static class in {
        ...
        static String[] rsaNL(int n) throws IOException {
