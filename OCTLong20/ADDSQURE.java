...
public class ADDSQURE {
    ...
    void main() throws IOException {
        ...
        BitSet vertical = new BitSet(mx);
        BitSet horizontal = new BitSet(mx);
        BitSet revHorizontal = new BitSet(mx);
        ...
        for (int i = 0; i < M; i++) {
            int a = in.ni();
            horizontal.set(a);
            revHorizontal.set(H - a);
        }

        BitSet verDiff = new BitSet(mx);
        BitSet horDiff = new BitSet(mx);
