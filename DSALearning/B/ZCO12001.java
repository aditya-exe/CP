...
class ZCO12001 {
    ...
    void main() throws IOException {
        ...
        int depth = 0;
        int nested_depth = 0;
        int nested_index = 0, index = 0;
        int maxchar_index = 0;
        int maxchar_length = 0;
        ...
        out.prln(nested_depth + " " + nested_index + " " + maxchar_length + " " + maxchar_index);
    }
