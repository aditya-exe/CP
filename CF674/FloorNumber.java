...
public class FloorNumber {
    ...
    void main() throws IOException {
        ...
        while (T-- > 0) {
            ...
            ArrayList<ArrayList<Integer>> floors = new ArrayList<>();
            floors.add(new ArrayList<>());
            floors.get(0).add(1);
            floors.get(0).add(2);
            floors.add(new ArrayList<>());
            for (int i = 3; i <= x + 2; i++) floors.get(1).add(i);
            floors.add(new ArrayList<>());
            for (int i = x + 3; i <= 2 * x + 2; i++) floors.get(2).add(i);
