...
public class SymmetricMatrx {
    public static void main(String[] $) throws IOException {
        SymmetricMatrx o = new SymmetricMatrx();
        o.main();
        out.flush();
        out.close();
    }
    ...
    void main() throws IOException {
        ...
        while (T-- > 0) {
            ...
            if (m % 2 != 0) {
                for (int i = 0; i < n; i++) {
                    Tile current = new Tile(sc.nextInt(), sc.nextInt(), sc.nextInt(), sc.nextInt());
                }
    ...
    static class Tile {
        ...
        public Tile(int one, int two, int three, int four) {
            this.one = one;
            this.two = two;
            this.three = three;
            this.four = four;
